...
export function OrderDetailsDining({ onNavigate, orderId }: OrderDetailsDiningProps) {
  ...
  const getDiningHallName = (diningHall?: string) => {
    ...
    return diningHallNames[diningHall || ''] || diningHall || 'Dining Hall';
  };
      ...
      <ScrollView style={styles.content} contentContainerStyle={styles.contentContainer}>
        ...
        <View style={styles.card}>
          ...
          <View style={styles.infoRow}>
            <MaterialCommunityIcons name="silverware-fork-knife" size={20} color="#003262" />
            <View style={styles.infoContent}>
              <Text style={styles.infoLabel}>Dining Hall</Text>
              <Text style={styles.infoValue}>{getDiningHallName(order.dining_hall)}</Text>
            </View>
          </View>
          <View style={styles.infoRow}>
        ...
        <TouchableOpacity
          ...
          onPress={() => onNavigate('chat-dining', orderId)}
        >
